...
$( document ).ready(function() {
  ...
  function filterDateFrom() {
    ...
    filter = Date.parse(document.getElementById("FilterDateFrom").value);
    table = document.getElementById("entries");
    tr = table.getElementsByTagName("tr");
    ...
    for (i = 0; i < tr.length; i++) {
        ...
        if (td) {
        txtValue = Date.parse(td.innerText);
        console.log(filter);
  ...
  function filterDateTo() {
    // Declare variables
    var filter, table, tr, td, i, txtValue;
    filter = Date.parse(document.getElementById("FilterDateTo").value);
    table = document.getElementById("entries");
    tr = table.getElementsByTagName("tr");
